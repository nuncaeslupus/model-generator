...
class TestWizardImports:
    ...
    def test_import_wizard_package(self):
...
class TestPromptsFallback:
    ...
    def no_questionary(self, monkeypatch):
    ...
    def test_select_retries_on_invalid(self):
        from model_generator.wizard.prompts import select
    ...
    def test_checkbox_single_selection(self):
    ...
    def test_checkbox_multiple_selection(self):
        from model_generator.wizard.prompts import checkbox
    ...
    def test_checkbox_all_selection(self):
        from model_generator.wizard.prompts import checkbox
    ...
    def test_text_default_on_empty(self):
        from model_generator.wizard.prompts import text
...
class TestMenuFlow:
    ...
    def test_generate_then_exit(self):
        from model_generator.wizard.menu import run_menu
    ...
    def test_run_tests_then_exit(self):
        from model_generator.wizard.menu import run_menu
...
class TestCleanAction:
    ...
    def test_clean_no_config(self, tmp_path, capsys):
...
class TestTestRunnerAction:
    ...
    def test_no_tests_dir(self, tmp_path, capsys):
