...
class TestInteractiveFlag:
    ...
    def test_clear_only_without_model(
...
class TestDryRunAndDiff:
    ...
    def test_diff_creates_no_files(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        from model_generator.generate import generate
...
class TestProjectRootResolution:
    ...
    def test_no_model_generator_yaml_exits_with_error(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestNoRootFilesFlag:
    ...
    def test_no_root_files_flag_propagates(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestStackResolution:
    ...
    def test_main_reads_stack_from_project_yaml(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_generate_resolves_stack_from_config(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
